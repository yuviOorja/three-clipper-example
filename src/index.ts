...
export class ClipperExample {
  constructor() {
    ...
    orbit.target.set(0, camera.position.y, 0);
    ...
    //   const union = new Mesh(
    //     new TextGeometry("Union", {
    //       font: font,
    //       size: 10,
    //       height: 0,
    //       bevelEnabled: false
    ...
    //   const difference = new Mesh(
    //     new TextGeometry("Difference", {
    //       font: font,
    //       size: 10,
    //       height: 0,
    //       bevelEnabled: false
